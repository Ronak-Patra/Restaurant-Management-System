                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-success" id="billing_table" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Table Number</th>
                                            <th>Order Number</th>
    	...
    	<form method="post" id="billing_form">
      		<div class="modal-content">
        		...
        		<div class="modal-footer">
          			...
          			<input type="submit" name="submit" id="submit_button" class="btn btn-success" value="Receive Payment" />
    ...
    $('#billing_form').on('submit', function(event){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                $('#submit_button').val('billing');
                $('#billingModal').modal('hide');
                dataTable.ajax.reload();
                window.location.href="<?php echo $object->base_url; ?>billing.php?action=Bill&order_id="+data
            }
        });
    });
